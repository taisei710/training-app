...
const DEPT_GOALS = [
  { id: 'kouji', label: '工事部',   color: '#378ADD', goal: 80 },
  { id: 'eigyo', label: '技術営業', color: '#1D9E75', goal: 80 },
  { id: 'jimu',  label: '営業事務', color: '#EF9F27', goal: 80 },
]
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.actionCards}>
        ...
        <button className={styles.actionCard} onClick={() => navigate('/trainee/sales-office-program')}>
          <span className={styles.actionCardIcon}>📋</span>
          <span className={styles.actionCardLabel}>教育プログラム</span>
        </button>
      </div>
